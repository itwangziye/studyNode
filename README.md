...
#### 阶段A:并发与数据一致性(关 47-52) ✅ 已完成 (2026-08-07 ~ 08-13)
...
| 49 | 乐观锁实战(文章防并发覆盖) | version 字段 + WHERE version=x;CAS 思想;updateMany+increment;ConflictException(409);update 调 findOne 的架构副作用 | 写出"两人同时编辑同一文章,后提交者被拒"接口 | ✅ |
